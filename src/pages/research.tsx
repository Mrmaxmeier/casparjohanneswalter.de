...
import { OrganKasselPlayer } from '../research/organ_kassel_player'
...
const partchFractionDescription = () => <p>
...
const musicCalculators: PageDef[] = [
  {
    id: "kithara",
  ...
  {
    id: "organ_kassel_player",
    title: "31 Tone Organ Kassel Player",
    component: OrganKasselPlayer,
  },
  {
...
const additionalMathTools: PageDef[] = [
  {
...
export class ResearchPage extends React.PureComponent<RouteComponentProps<any>, {}> {
  public render() {
    const link = (id: string, title: string) => <li key={id}>
