...
import { Rechner as PartchBruchRechner } from '../research/partch_bruch_rechner.js'
...
export class PartchBruch extends React.Component {
  render () {
    return <PartchBruchRechner />
  }
}
  ...
  render () {
    return (
      <div>
        ...
        <span>
          <Link to='/research/partch_bruch_rechner'>Partch Bruch Rechner</Link>
          <p>
