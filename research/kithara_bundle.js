...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kithara_components = __webpack_require__(1);

	var React = __webpack_require__(4);
	var ReactDOM = __webpack_require__(162);

	console.log(_kithara_components.KitharaCalc);

	ReactDOM.render(React.createElement(_kithara_components.KitharaCalc, null), document.getElementById('kitharacalc'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.KitharaCalc = undefined;

	var _kithara_presets = __webpack_require__(2);

	var _kithara_math = __webpack_require__(3);
	...
	var nonNaN = function nonNaN(n) {
		return isNaN(n) ? "" : n;
	};

	var RatioInput = (function (_React$Component) {
		_inherits(RatioInput, _React$Component);

		function RatioInput() {
			_classCallCheck(this, RatioInput);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(RatioInput).apply(this, arguments));
		}

		_createClass(RatioInput, [{
			key: 'handleChange',
			...
			value: function render() {
				var invalid = isNaN(this.props.data);
				var style = invalid ? { borderColor: 'red' } : {};
				var val = nonNaN(this.props.data);
				return React.createElement(
					'td',
					null,
					React.createElement('input', { type: 'text', tabIndex: this.props.tabIndex, defaultValue: val,
	...
	var LowerInput = (function (_React$Component2) {
		_inherits(LowerInput, _React$Component2);

		function LowerInput() {
			_classCallCheck(this, LowerInput);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(LowerInput).apply(this, arguments));
		}

		_createClass(LowerInput, [{
			key: 'getImg',
			value: function getImg() {
				var a = Math.floor(((0, _kithara_math.frac_to_cent)(this.props.frac) + 100 / 12) * 72 / 1200);
				var x = this.props.octave + Math.floor(a / 72);
			...
			value: function getCentDisp() {
				...
				var cents = (0, _kithara_math.frac_to_cent)(this.props.frac);
				var near = Math.round(cents / 100) * 100;
				var diff = Math.round((cents - near) * 10) / 10;
			...
			value: function render() {
				...
				var cents = this.getCentDisp();
				var octave = nonNaN(this.props.octave);
				var invalid = isNaN(this.props.octave) || this.props.octave == null;
				var style = invalid ? { width: "3.5em", heigh: "1.5em", borderColor: 'red' } : { width: "3.5em", heigh: "1.5em" };
				if (this.props.index == 0) {
					if (this.props.isUpper) {
						return React.createElement('td', { className: 'hidden' });
					} else {
						var overtone = this.props.overtone ? this.props.overtone : "";
						return React.createElement(
							'td',
							null,
							React.createElement(
								'a',
								{ href: '#', 'data-row': '1', onClick: function onClick() {
										_this3.props.applyCB();
									} },
								'apply identity'
							),
							...
							React.createElement(
								...
								null,
								'Overtone:',
								React.createElement('input', { type: 'text', tabIndex: this.props.tabIndex,
									placeholder: '', defaultValue: overtone, value: overtone,
									onChange: function onChange(d) {
										_this3.props.setOvertone(parseInt($(d.target).val()));
				...
				return React.createElement(
					...
					React.createElement(
						...
						{ className: 'subs' },
						'Octave:',
						React.createElement('input', { type: 'text', tabIndex: this.props.tabIndex, style: style,
							placeholder: '3', defaultValue: octave, value: octave,
							onChange: function onChange(d) {
								_this3.props.setOctaveCB(_this3.props.index, parseInt($(d.target).val()));
							} })
					),
					React.createElement(
						'div',
					...
					this.props.isUpper ? null : React.createElement(
						'a',
						{ href: '#', 'data-row': '1', onClick: function onClick() {
								_this3.props.applyCB();
							} },
					...
					React.createElement('img', { style: { maxWidth: "5em" }, src: this.getImg() })
				);
			}
		}]);
	...
	var Row = (function (_React$Component3) {
		...
		_createClass(Row, [{
			...
			value: function render() {
				...
				var isUpper = this.props.isUpper;
				...
				data.map(function (d, index) {
					var firstCB = function firstCB(val) {
						_this5.props.setCB(index, [parseInt(val), d.ratio[1]]);
					};
					var secondCB = function secondCB(val) {
						_this5.props.setCB(index, [d.ratio[0], parseInt(val)]);
					};
					var spacer = React.createElement('td', { className: 'hidden', key: 'spacer_' + index });
					var tabIndexBase = index * 3 + (isUpper ? 1 : 999);
					firstRow.push(React.createElement(RatioInput, { tabIndex: tabIndexBase, data: d.ratio[0], key: 'input_' + index, changeCB: firstCB }));
					firstRow.push(spacer);
					secondRow.push(React.createElement(RatioInput, { tabIndex: tabIndexBase + 1, data: d.ratio[1], key: 'input_' + index, changeCB: secondCB }));
					secondRow.push(spacer);
					thirdRow.push(React.createElement(LowerInput, { isUpper: isUpper, frac: d.ratio, octave: d.octave,
						tabIndex: tabIndexBase + 2, key: 'input_' + index,
						applyCB: function applyCB() {
							_this5.props.applyCB(index);
						},
						index: index, setOctaveCB: _this5.props.setOctave,
						setOvertone: _this5.props.setOvertone, overtone: _this5.props.overtone }));
	...
	var KitharaCalc = exports.KitharaCalc = (function (_React$Component4) {
		_inherits(KitharaCalc, _React$Component4);

		function KitharaCalc(props) {
			_classCallCheck(this, KitharaCalc);

			var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(KitharaCalc).call(this, props));

			_this6.state = _this6.setStateFromPreset("Kithara I", "Hexad 1, green", false);
			return _this6;
		}

		_createClass(KitharaCalc, [{
			key: 'setStateFromPreset',
			value: function setStateFromPreset(instrument, preset) {
				var setState = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];

				var p = _kithara_presets.presets[instrument][preset];
				var row = p.map(function (a, index) {
					if (index == 0) {
						return {
							ratio: [a[0], a[1]],
							type: a[2]
				...
				var state = {
					upperRow: row,
					lowerRow: (0, _kithara_math.calcState)(row, {
						ratio: [3, 2],
						octave: 3,
						index: 2
					}),
			...
			key: 'setPreset',
			value: function setPreset(d) {
				var preset = $(d.target).val();
				console.log("setPreset", preset);
				this.setStateFromPreset(this.state.instrument, preset);
			}
		}, {
			key: 'setInstrument',
			value: function setInstrument(d) {
				var instrument = $(d.target).val();
				var preset = Object.keys(_kithara_presets.presets[instrument])[0];
				console.log("setInstrument", instrument);
				this.setStateFromPreset(instrument, preset);
			}
		}, {
			key: 'setRatioCB',
			value: function setRatioCB(isUpper, index, ratio) {
			...
			key: 'setOctave',
			value: function setOctave(isUpper, index, octave) {
			...
			key: 'setOvertone',
			value: function setOvertone(overtone) {
				if (!overtone) {
					this.clearOvertone();
					return;
				}
				...
				state.lowerRow = (0, _kithara_math.calcOvertone)(state, overtone);
				this.setState(state);
			}
		}, {
			key: 'clearOvertone',
			value: function clearOvertone() {
				var lowerRow = this.state.lowerRow.map(function (e) {
					return {
						ratio: e.ratio,
						octave: e.octave,
						overtone: null
				...
				this.setState({ lowerRow: lowerRow });
			}
		}, {
			key: 'handleApply',
			value: function handleApply(index) {
				console.log(this, index);
				var state = $.extend(true, this.state, {
					upperRow: this.state.upperRow,
					lowerRow: (0, _kithara_math.calcState)(this.state.upperRow, {
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'select',
							{ onChange: this.setInstrument.bind(this) },
							$.map(_kithara_presets.presets, function (_, key) {
								return React.createElement(
									'option',
									{ key: key, value: key },
									key
						...
						React.createElement(
							...
							$.map(_kithara_presets.presets[this.state.instrument], function (_, key) {
								return React.createElement(
									'option',
									{ key: key, value: key },
									key
					...
					React.createElement(Row, { isUpper: true, data: this.state.upperRow,
						setCB: this.setRatioCB.bind(this, true),
						setOctave: this.setOctave.bind(this, true),
						applyCB: this.handleApply.bind(this) }),
					React.createElement(Row, { isUpper: false, data: this.state.lowerRow,
...
/***/ function(module, exports) {
	...
	var presets = exports.presets = {
		...
		"Pedal Steel Guitar": {
			"O - 1 / 1": [[1, 1, "o"], [3, 2, 2], [1, 1, 2], [5, 4, 2], [3, 2, 3], [7, 4, 3], [9, 8, 3], [11, 8, 4], [3, 2, 4], [7, 4, 4], [1, 1, 4]],
			"O - 1 / 1, mit 13": [[1, 1, "o"], [3, 2, 2], [1, 1, 2], [5, 4, 2], [3, 2, 3], [7, 4, 3], [9, 8, 3], [11, 8, 4], [13, 8, 4], [7, 4, 4], [1, 1, 4]],
			"U - 9 / 8": [[9, 8, "u"], [18, 11, 2], [1, 1, 2], [9, 7, 2], [3, 2, 3], [9, 5, 3], [9, 8, 3], [9, 7, 3], [3, 2, 4], [9, 5, 4], [9, 8, 4]]
		}
	};
...
/***/ function(module, exports) {
	...
	exports.cpy = cpy;
	exports.repr = repr;
	exports.frac_to_cent = frac_to_cent;
	exports.calcState = calcState;
	exports.calcOvertone = calcOvertone;
	function gcd(a, b) {
	...
	function reduce(ratio) {
		var gcd_ = gcd(ratio[0], ratio[1]);
	...
	function getMultiplier(obj) {
		...
		var octave = obj.octave ? obj.octave : 0;
	...
	function calcState(state, obj) {
		...
		return state.map(function (obj, index) {
	...
	function calcOvertone(state, overtone) {
